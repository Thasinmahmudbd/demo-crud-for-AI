...
<body>
    ...
    <div class="disGrid gridGap_1 w_40Per m_a">
        ...
        <form action="{{url('/login/user')}}" method="post"  class="disGrid gridGap_1">
        @csrf
            ...
            <input class="successBtnR fSize_1 lato disGrid m_a w_100Per" value="Login" type="submit">

        </form>

        <a class="link" href="{{url('/register')}}">New-Register</a>
